...
function loadStatsPage()
{
	...
	for(var rowNum = 2; rowNum < table.rows.length; rowNum++)
	{
		...
		homeScore = parseInt(row.cells[2].innerHTML);
		otherScore = parseInt(row.cells[3].innerHTML);
		if(homeScore > otherScore) {
			wins++;
	...
	//update wins vs losses table values
...
function loadPlayersPage()
{
	...
	for(playerIndex in players)
	{
		...
		player_selector.appendChild(player);
